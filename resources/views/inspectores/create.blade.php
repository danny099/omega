...
@section('contenido')
  <ol class="breadcrumb">
    ...
    <li><a href="{{ url('inspectores') }}">Inspectores</a></li>
    <li class="active">Crear Inspector</li>
  </ol>
  <div class="container">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 >Crear Inspector</h3>
      </div>
      ...
      <!-- /.box-header -->
      <!-- form start -->
        {!! Form::open(['url' => 'inspectores','enctype'=>'multipart/form-data','method' => 'post']) !!}
        {{ csrf_field() }}
        <div class="row">
