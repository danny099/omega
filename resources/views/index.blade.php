        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('photos')}}/{{$perfil->foto}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::User()->nombres}} {{Auth::User()->apellidos}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{url('photos')}}/{{$perfil->foto}}" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('usuarios') }}/{{ Auth::User()->id }}" class="btn btn-default btn-flat">Perfil</a>
                </div>
