...
@section('contenido')
  <ol class="breadcrumb">
    ...
    <li class="active">Crear informe tecnico detallado</li>
  </ol>
  <div class="container" style=" margin-left: 0px; margin-right: 0px; width:100%">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 >Crear informe tecnico detallado</h3>
      </div>
      ...
      <!-- form start -->
        <div class="row">
          <form class="" action="{{ url('criterio') }}" method="post">
            {{ csrf_field() }}
            <div class="col-md-12">
              <div class="col-md-6">
                <label>Items</label>
            ...
            @foreach($items as $key=>$item)
              <div class="col-md-12 well" style="width:95%; margin-left:30px">
                ...
                <div class="col-md-4" >
                  <textarea class="form-control" rows="3" id="comment" name="observaciones[][{{$key}}]"></textarea>
