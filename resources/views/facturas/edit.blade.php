        ...
        <div class="box-body col-md-6">
          <br>
            ...
            <div class="form-group">
              ...
              {!! Form::number('retenciones', null, ['class' => 'form-control']) !!}
            </div>

            <div class="form-group">
              {!! Form::label('amortizacion', 'Amortizacion:') !!}
              {!! Form::number('amortizacion', null, ['class' => 'form-control' ]) !!}
            </div>

            <div class="form-group">
              {!! Form::label('polizas', 'Polizas:') !!}
              {!! Form::number('polizas', null, ['class' => 'form-control' ]) !!}
            </div>

            <div class="form-group">
              {!! Form::label('retegarantia', 'Retegarantia:') !!}
              {!! Form::number('retegarantia', null, ['class' => 'form-control' ]) !!}
            </div>

            <div class="form-group">
              {!! Form::label('valor_pagado', 'Valor pagado:') !!}
              {!! Form::number('valor_pagado', null, ['class' => 'form-control' ]) !!}
            </div>
