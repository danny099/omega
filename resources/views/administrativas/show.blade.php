      ...
      <div class="container">
        <div class="box box-primary">
          <div class="">
           ...
           <a class="btn btn-primary" href="<?php echo '/documento'.'/'.$administrativa->codigo_proyecto .'-'. $administrativa->nombre_proyecto.'.xml'; ?>" style="background-color: #33579A; border-color:#33579A;position: relative; left: 950; top: -40;" >Descargar contrato</a>
