...
$(function() {
   ...
   $(".generar").on("click",function( event ) {
    ...
    $('.tabla tr:last').after('<tr class="actualizar"><td Colspan="3"></td><td><label>Metodo de pago:</label></td><td><div class="radio" style="margin-left: 20px;"><input type="radio" name="pago" value="0" required="required"> Banco de bogota </div><div class="radio" style="margin-left: 20px;"><input type="radio" name="pago" value="1" required="required"> Bancolombia</div></td></tr>');
