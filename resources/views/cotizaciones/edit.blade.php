      ...
      <div class="col-md-12" style="margin-top:20px; margin-bottom:20px">
        ...
        <div class="col-md-3">
          ...
          <select name="formas_pago" style="width:100%" required>
            ...
            <option value="Según acuerdo">Según acuerdo</option>
          </select>
        </div>
        <div class="col-md-3">
...
$(function() {
   ...
   $(".generar").on("click",function( event ) {
    ...
    $('.tabla tr:last').after('<tr class="actualizar"><td Colspan="3"></td><td><label>Costo adicional de visita por día si se requiere:</label></td><td><input type="text" class="form-control adici" placeholder= "Valor" onkeyup="mascara(this,cpf)" value="{{$cotizaciones->adicional}}" name="adici"  required="" ></td></tr>');
    $('.tabla tr:last').after('<tr class="actualizar"><td Colspan="3"></td><td><label>Metodo de pago:</label></td><td><div class="radio" style="margin-left: 20px;"><input type="radio" name="pago" value="0" required="required"> General </div><div class="radio" style="margin-left: 20px;"><input type="radio" name="pago" value="1" required="required"> Outsourcing</div><div class="radio" style="margin-left: 20px;"><input type="radio" name="pago" value="2" required="required"> Seccion neiva </div></td></tr>');
