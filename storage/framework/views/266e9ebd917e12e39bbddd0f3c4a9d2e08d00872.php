<div class="container">
  <div class="">
    <div class="">
      ...
      <!-- /.box-header -->
      <!-- form start -->
        <?php echo Form::open(['url' => 'juridica']); ?>
        ...
        <div class="box-body col-md-6">
          ...
          <div class="form-group">
            <?php echo Form::label('razon', 'Razón social'); ?>

            <?php echo Form::text('razon', null, ['class' => 'form-control' , 'required' => 'required']); ?>
          ...
          <div class="form-group">
            <?php echo Form::label('nombre', 'Nombre representante legal'); ?>
