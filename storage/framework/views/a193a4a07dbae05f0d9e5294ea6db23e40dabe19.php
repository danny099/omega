<?php $__env->startSection('contenido'); ?>
  ...
  <div class="container">
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
      <!-- form start -->
        <?php echo Form::model($clientes, ['method' => 'PATCH', 'action' => ['ClienteController@update',$clientes->id]]); ?>
        ...
        <div class="box-body col-md-6">
          ...
          <div class="form-group">
            ...
            <select class="form-control" required="" name="departamento_id" id="departamento">
              <option value="<?php echo e($clientes->departamento->id); ?>"><?php echo e($clientes->departamento->nombre); ?></option>
          ...
          <div class="form-group">
            ...
            <select class="form-control" required="" name="municipio" id="municipio">
              <option value="<?php echo e($municipios->id); ?>"><?php echo e($municipios->nombre); ?></option>
              <option value=""></option>
            </select>
          </div>
