              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(url('dist/img/user3-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(url('dist/img/user4-128x128.jpg')); ?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo e(url('administrativas')); ?>"><i class="fa fa-circle-o"></i>Administrativa</a></li>
...
<!-- Morris.js charts -->
<script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js')); ?>"></script>
...
<!-- daterangepicker -->
<script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js')); ?>"></script>
