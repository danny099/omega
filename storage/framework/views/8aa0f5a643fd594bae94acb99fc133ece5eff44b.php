<?php $__env->startSection('contenido'); ?>
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo e(url('documentos')); ?>">Documentos</a></li>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <?php echo Form::model($documento, ['method' => 'PATCH', 'action' => ['DocumentoController@update',$documento->id]]); ?>
                ...
                <?php echo e(csrf_field()); ?>
                  ...
                  <div class="col-md-12">
                    <div class="col-md-3">
                      ...
                      <input type="text" name="nombre" class="form-control" value="<?php echo e($documento->nombre); ?>">
                      <br>
                    </div>
                    <div class="col-md-3">
