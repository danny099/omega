...
<html lang="es">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?php echo e(url('assets/css/ace.min.css')); ?>" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<?php echo e(url('assets/css/ace-part2.min.css')); ?>" />
		<![endif]-->
		<link rel="stylesheet" href="<?php echo e(url('assets/css/ace-rtl.min.css')); ?>" />

		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="<?php echo e(url('assets/css/ace-ie.min.css')); ?>" />
		<![endif]-->
	...
	<body class="login-layout light-login" style="background-size: cover; background-image: url('<?php echo e(url('Fondo3.jpg')); ?>">
		...
		<div class="main-container">
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<?php if(Session::has('message')): ?>
								...
								<div id="alert" class="alert alert-<?php echo e(Session::get('class')); ?>">
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo e(url('check')); ?>" id="validation-login" method="post">
			...
			<img src="<?php echo e(url('logo.png')); ?>" style="position:absolute; right:2%; top:70%; height: auto;">
		</div><!-- /.main-container -->
		...
		<!--[if IE]>
			<script src="<?php echo e(url('assets/js/jquery-1.11.3.min.js')); ?>"></script>
		<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='<?php echo e(url('assets/js/jquery.mobile.custom.min.js')); ?>'>"+"<"+"/script>");
		</script>

		<!-- inline scripts related to this page -->
		<script src="<?php echo e(url('assets/js/jquery.validate.min.js')); ?>"></script>
		<script src="<?php echo e(url('assets/js/jquery-additional-methods.min.js')); ?>"></script>
